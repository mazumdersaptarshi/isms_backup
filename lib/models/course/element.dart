...
class Element<T> {
  ...
  /// so we need to make this variable generic for the `elementContent` variable.
...
/// for each type of data returned in the JSON field `elementContent`.
///
...
/// conditional logic when displaying the element **only in Dart**; here we need to
